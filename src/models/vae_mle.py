...
# decoder with learned variance (softplus parameterization)
...
class VAE(Model):
   """MLE-style VAE with learned output variance."""
   ...
   def compute_loss_components(self, x, mu, logvar, z_mean, z_log_var):
       ...
       # mle reconstruction: negative log likelihood with learned variance
